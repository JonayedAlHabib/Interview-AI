...
const Interview = () => {
    ...
    const scoreCaption =
        report.matchScore >= 80 ? 'Strong match for this role' :
            report.matchScore >= 60 ? 'Moderate match for this role' : 'Significant gaps for this role'
    ...
    return (
        <div className='interview-page'>
            ...
            <div className='interview-header'>
                <button className='header-btn header-btn--back' onClick={handleBackClick}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="19" y1="12" x2="5" y2="12" /><polyline points="12 19 5 12 12 5" /></svg>
                    Back
                </button>
                <button className='header-btn header-btn--logout' onClick={handleLogoutClick}>
            ...
            <div className='interview-layout'>
                ...
                <nav className='interview-nav'>
                    ...
                    <button
                        onClick={() => { getCoverLetterPdf(interviewId) }}
                        className='button secondary-button' style={{ marginTop: '0.6rem' }}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" style={{ marginRight: "0.6rem" }} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z" /><path d="M4 4l8 8 8-8" /></svg>
                ...
                <aside className='interview-sidebar'>
                    ...
                    <div className='match-score'>
                        ...
                        <p className={`match-score__sub ${scoreColor}`}>{scoreCaption}</p>
                    </div>
